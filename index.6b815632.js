...
},{"./core/router":"f4hn2","./store":"1eAgN","./page":"4GSC5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"f4hn2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"1eAgN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Store {
    constructor(){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4GSC5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../config":"gTux2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gTux2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class NewsFeedView extends (0, _viewDefault.default) {
    ...
    async render() {
      ...
      `);
        ...
        this.setTemplatedata("prev_page", `<a href="#/page/${this.store.prevPage}" class="${this.store.currentPage > 1 ? "text-gray-500" : "pointer-events-none text-gray-200"}">Previous</a>`);
        this.setTemplatedata("next_page", `<a href="#/page/${this.store.nextPage}" class="ml-4 ${this.store.currentPage < this.totalPages ? "text-gray-500" : "pointer-events-none text-gray-200"}">Next</a>`);
        this.updateView();
    }
}
exports.default = NewsFeedView;

},{"../core/view":"gCNZN","../core/api":"5JfgJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lSgxL","kuM8f"], "kuM8f", "parcelRequireb0f2")
